...
configuration.
\dt[R2, per IB: rename domains to match the source paper -- evidential $\to$ empirical, ethics $\to$ ethical, roleplay $\to$ roleplaying, insider\_trd $\to$ insider trading (repe\_honesty unchanged) -- in the text and in the Fig.~2 labels (gen\_paper\_figs.py). Dead zone confirmed on; TCAM claims stand]{}
...
$Y$. The top row of the same figure places the published
